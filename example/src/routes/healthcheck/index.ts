import { AponiaAfterRequestHandler, AponiaCtx, AponiaDecorator, AponiaHooks, AponiaRouteHandler, AponiaRouteHandlerFn } from "aponia/src";

export const getDateDecorator: AponiaDecorator = ["getDate", () => Date.now()]

export const getHealthcheck: AponiaRouteHandlerFn<{ status: string, timestamp: number }> = (ctx: AponiaCtx) => {
